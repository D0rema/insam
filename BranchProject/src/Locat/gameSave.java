...
public class gameSave {
	static String cwd = Main.class.getProtectionDomain().getCodeSource().getLocation().getPath();//현재 파일이 실행되고 있는 폴더 위치
	static File file = new File(cwd+"data.txt"); // 저장경로에 txt 파일

	/**
	 * Saving the stage path
	 * The stage number is saved in txt file
	 * @author Mihye
	 */
	...
	/**
	 * finding out a txt file
	 * if there is the saved txt file, return true.
	 * @author Mihye
	 */
